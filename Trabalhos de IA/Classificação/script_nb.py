...
def validacao_nb():
	...
	while op < 10:
		...
		op+=1
	file = open("validacao_nb2.txt", 'w')
	file.write("Resultados obtidos através de Validação cruzada para o algoritmo Naive Bayes gaussiano utilizando biblioteca sklearn \n")
